      ...
      >
        <div v-show="mobileMenuOpen" class="md:hidden py-4 border-t border-zinc-800/80 bg-black/95">
          <div class="flex flex-col space-y-1 text-base font-semibold">
            <NuxtLink to="/" class="hover:text-red-500 hover:bg-zinc-900/80 rounded-xl px-4 py-3 transition-colors" active-class="text-red-500 font-bold bg-zinc-900/90" @click="mobileMenuOpen = false">{{ t('nav.pizzeria') }}</NuxtLink>
