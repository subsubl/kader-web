...
const sl: Dict = {
  ...
  club: {
    ...
    floorsTitle: 'Dva nadstropja. En grajski prostor.',
    floorLabel: 'Nadstropje',
    floor01Title: 'Kletni klub',
    floor01Desc: 'Sestopi v obokano klet in vstopi v svet globokih basov in intenzivnih setov. Zaprte kamnite stene, Klipsch La Scala zvočniki in gosto ozračje ustvarjajo enega najtesnejših klubskih prostorov v regiji — brez okrasja, samo glasba.',
    floor02Title: 'Pritličje & vrt',
    floor02Desc: 'Nivo tal je osrednje stičišče gradu. Od koktajl bara do pizerije, od plesišča do poletnega vrta — prostor, kjer se noč začne in razvija. Dnevna sončna lega, zeleni vrt in spontana energija ga naredijo za prostor za vsakogar.',
    tagCapacity300: '300 obiskovalcev',
    tagLowCeiling: 'Obok klet',
  ...
  buyouts: {
    ...
    venueTitle: 'Grajsko prizorišče za vsak poseben trenutek',
...
const en: Dict = {
  ...
  club: {
    ...
    floorsTitle: 'Two floors. One castle.',
    floorLabel: 'Floor',
    floor01Title: 'The Basement Club',
    floor01Desc: 'Step down into the vaulted basement and enter a world of deep bass and relentless sets. Stone walls, Klipsch La Scala speakers and a dense atmosphere make this one of the most intimate club rooms in the region — no frills, just music.',
    floor02Title: 'Ground Floor & Garden',
    floor02Desc: 'The ground level is the social heart of the castle. From the cocktail bar to the pizzeria, from the dance floor to the summer garden — a space where the night begins and evolves. Sunny daytime access, a lush garden and spontaneous energy make it a place for everyone.',
  ...
  buyouts: {
    ...
    venueTitle: 'A castle venue for every special occasion',
    howItWorks: 'How booking works',
    choosePlan: 'Choose a package',
