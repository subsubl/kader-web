...
const sl: Dict = {
  ...
  events: {
    ...
    syncedFromRA: 'Sinhronizirano z naše Resident Advisor strani — nove objave se prikažejo samodejno',
...
const en: Dict = {
  ...
  events: {
    ...
    syncedFromRA: 'Synced from our Resident Advisor page — new posts appear automatically',
